		...
		<SelectPrimitive.Root name={name} onValueChange={onChange} value={value}>
			...
			<SelectPrimitive.Portal>
				<SelectPrimitive.Content
					className="z-50 w-(--radix-select-trigger-width) animate-dropdown-in overflow-hidden rounded-input border border-base-400 bg-white shadow-lg data-[state=closed]:animate-dropdown-out"
					position="popper"
					sideOffset={4}
				>
